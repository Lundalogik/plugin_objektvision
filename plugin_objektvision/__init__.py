...
def default_config():
    ...
    `lime_config.config['plugins']['plugin_objektvision']`
...
try:
    ...
    logger.info('plugin_objektvision doesn\'t implement any custom '
                'endpoints')

try:
    from .event_handlers import register_event_handlers  # noqa
except ImportError:
    logger.info('plugin_objektvision doesn\'t implement any event '
                'handlers')

try:
    from .limeobject_classes import register_limeobject_classes  # noqa
except ImportError:
    logger.info('plugin_objektvision doesn\'t implement any '
                'limeobject classes')
...
try:
    ...
    logger.info('plugin_objektvision doesn\'t contain any '
                'translations')
...
def register_static_content():
    ...
    `/<rooturl-to-app>/static/<plugin-name>/<route>.
